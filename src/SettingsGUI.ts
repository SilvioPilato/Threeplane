...
export default (defaultSettings: GameSettings, onChange: (componentName: GameSettingsOptions, value: any) => void) => {
    const { gridXSize, gridYSize, gridCellSize, noiseLacunarity, noiseOctaves, octavesPersistence, noiseScale, maxHeight, onWorldGen } = defaultSettings;
    const settings = {
